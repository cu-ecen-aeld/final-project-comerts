#!/bin/bash
# Script to build image for RaspberryPI Zero W 2.
...
IMAGE_ADD="IMAGE_INSTALL:append = \"linux-firmware-rpidistro-bcm43436 v4l-utils python3 ntp wpa-supplicant\""

#add u-boot
#IMAGE_ADD="IMAGE_INSTALL:append = \"u-boot-rpi\""
